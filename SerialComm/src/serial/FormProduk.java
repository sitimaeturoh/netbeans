...
public class FormProduk extends javax.swing.JFrame {
    ...
    public FormProduk() {
        ...
        model = new DefaultTableModel(new Object [][]{},
                new Object[] {"ID", "NAMA PRODUK", "HARGA PRODUK"});
        tbProduk.setModel(model); 
    }
    
    public static void refreshProduk(){
       tbProduk.setModel(model);
       if(tbProduk.getRowCount()>0);
        tbProduk.setRowSelectionInterval(0, 0);
    }   
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        ...
        TambahProduk tambah = new TambahProduk(this, true);
    ...
    public static javax.swing.JTable tbProduk;

...
public class Tambah extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cmbAgama.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Islam", "Hindu", "Budha", "Kristen", "Katholik" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String jk = rbLaki2.isSelected() ? "Laki-Laki" : "Perempuan";
        String kelas = cmbAgama.getSelectedItem().toString();
        Object[] data = {nim, nama, alamat, jk, kelas};
        Data.model.addRow(data);
